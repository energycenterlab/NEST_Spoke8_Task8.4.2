...
Modified from Mosaik-components. The mosaik HDF5 storage backend was created by Stefan Scherfke. GNU LGPLv2.1
...
from src.definitions import TEMP_ROOT, OUTPUTS_ROOT
#from coesi.utils import scn_config_load
...
class MosaikHdf5(mosaik_api_v3.Simulator):
    ...
    def init(self, sid, step_size, duration, time_resolution=1., series_path=(None, None), sim_meta=None):
        ...
        self.sid = sid
        self.step_size = int(step_size*time_resolution)
        ...
        if self.meta['models'] == {}:  # Todo: definire meglio per hdf5 come fornire il meta. meglio automaticoo
    ...
    def finalize(self):
        ...
        logger.info(f'Simulation data saved in Outputs folder as {self.filename}')
...
if __name__ == '__main__':
    desc = __doc__.strip()
    mosaik_api_v3.start_simulation(MosaikHdf5(), desc)
