...
_SAMPLE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='villas.node.Sample.timestamp', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='values', full_name='villas.node.Sample.values', index=3,
...
_VALUE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='b', full_name='villas.node.Value.b', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='z', full_name='villas.node.Value.z', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COMPLEX = _descriptor.Descriptor(
  name='Complex',
  full_name='villas.node.Complex',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='real', full_name='villas.node.Complex.real', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='imag', full_name='villas.node.Complex.imag', index=1,
...
_VALUE.fields_by_name['z'].message_type = _COMPLEX
...
_VALUE.oneofs_by_name['value'].fields.append(
  _VALUE.fields_by_name['z'])
_VALUE.fields_by_name['z'].containing_oneof = _VALUE.oneofs_by_name['value']
